...
type BrandListHandlerFunc func(BrandListParams, *int) BrandListResponder

// Handle executing the request and returning a response
func (fn BrandListHandlerFunc) Handle(params BrandListParams, principal *int) BrandListResponder {
	return fn(params, principal)
}

// BrandListHandler interface for that can handle valid brand list params
type BrandListHandler interface {
	Handle(BrandListParams, *int) BrandListResponder
}
