...
type ListProductHandlerFunc func(ListProductParams, *int) ListProductResponder

// Handle executing the request and returning a response
func (fn ListProductHandlerFunc) Handle(params ListProductParams, principal *int) ListProductResponder {
	return fn(params, principal)
}

// ListProductHandler interface for that can handle valid list product params
type ListProductHandler interface {
	Handle(ListProductParams, *int) ListProductResponder
}
...
/*ListProduct swagger:route GET /products listProduct
