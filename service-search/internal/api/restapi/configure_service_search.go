...
//go:generate swagger generate server --target ../../api --name ServiceSearch --spec ../swagger.yml --principal string --exclude-main --strict

func configureFlags(api *operations.ServiceSearchAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ServiceSearchAPI) http.Handler {
