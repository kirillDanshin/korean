...
type RegistrationHandlerFunc func(RegistrationParams) RegistrationResponder

// Handle executing the request and returning a response
func (fn RegistrationHandlerFunc) Handle(params RegistrationParams) RegistrationResponder {
	return fn(params)
}

// RegistrationHandler interface for that can handle valid registration params
type RegistrationHandler interface {
	Handle(RegistrationParams) RegistrationResponder
}
...
/*Registration swagger:route POST /user registration
