...
/*ProductPOSTOK The server successfully processed the request.
...
func (o *ProductPOSTOK) WithPayload(payload *models.Success) *ProductPOSTOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the product p o s t o k response
func (o *ProductPOSTOK) SetPayload(payload *models.Success) {
	o.Payload = payload
}
